...
- **Video embed parsing** — `{{video URL}}` and bare YouTube paragraph syntax → `VideoEmbed` AST node with allowlist and round-trip `source_text`. See [`video-embed-parsing.md`](docs/technical/markdown/video-embed-parsing.md).
