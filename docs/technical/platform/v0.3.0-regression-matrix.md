...
| RS-2a | Formatted wrapped paragraph click | `layout_wrap_width` paint/hit-test parity | Narrow window; long formatted paragraph wrapping to 2+ lines; click **second visual line** |
| RS-2b | Formatted link label click | display→raw through link brackets | Formatted paragraph with `[label](url)`; click mid-label text |
...
| RS-2a | Caret on second visual line (not first); correct after window resize |
| RS-2b | Caret inside `[...]` brackets in raw markdown |
