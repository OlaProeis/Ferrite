...
| Condition | UI |
|-----------|-----|
| Trusted YouTube with valid `video_id`, WebView succeeds | Inline wry child WebView at embed rect (relay page → `youtube-nocookie.com` iframe) |
...
- `youtube_thumbnail_url_*`, `provider_embed_url_*`
